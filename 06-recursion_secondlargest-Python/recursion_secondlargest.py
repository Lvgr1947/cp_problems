...
# Note: recall that you may not use sort, sorted, min, or max this week! With that in mind, 
# write the function 
# recursion_secondlargest(L) that takes a list of integers in any order and 
# returns the second-largest value in the list. To 
# be more precise, it returns the second value from the end if the list was sorted 
# (though you do not need to sort 
# it to solve this problem), so if the largest value occurs twice, 
# you would return that value. Also, if there are 
